...
@section('content')
<h1>Blender Committee</h1>
<form action="{{route('Insert','2')}}" method="POST">
        {{ csrf_field() }}
                    ...
                    <tbody>
                       @foreach ($appointments as $appointments)
                            <tr>
                                ...
                                <td><a href="{{route('Delete',['committee_id'=>'2','id'=>$appointments->id])}}" class="btn btn-danger">Delete</a></td>
